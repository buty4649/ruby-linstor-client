...
# Unit tests for LinstorClient::Candidate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::Candidate do
  let(:instance) { LinstorClient::Candidate.new }

  describe 'test an instance of Candidate' do
    it 'should create an instance of Candidate' do
      expect(instance).to be_instance_of(LinstorClient::Candidate)
    end
  end
  ...
  describe 'test attribute "max_volume_size_kib"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "node_names"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "all_thin"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
