...
# Unit tests for LinstorClient::SnapshotVolumeDefinition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::SnapshotVolumeDefinition do
  let(:instance) { LinstorClient::SnapshotVolumeDefinition.new }

  describe 'test an instance of SnapshotVolumeDefinition' do
    it 'should create an instance of SnapshotVolumeDefinition' do
      expect(instance).to be_instance_of(LinstorClient::SnapshotVolumeDefinition)
    end
  end
  ...
  describe 'test attribute "size_kib"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
