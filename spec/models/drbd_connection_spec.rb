...
# Unit tests for LinstorClient::DrbdConnection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::DrbdConnection do
  let(:instance) { LinstorClient::DrbdConnection.new }

  describe 'test an instance of DrbdConnection' do
    it 'should create an instance of DrbdConnection' do
      expect(instance).to be_instance_of(LinstorClient::DrbdConnection)
    end
  end
  ...
  describe 'test attribute "message"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["StandAlone", "Disconnecting", "Unconnected", "Timeout", "BrokenPipe", "NetworkFailure", "ProtocolError", "Connecting", "TearDown", "Connected", "Unknown"])
