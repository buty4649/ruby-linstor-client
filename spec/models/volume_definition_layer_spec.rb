...
# Unit tests for LinstorClient::VolumeDefinitionLayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::VolumeDefinitionLayer do
  let(:instance) { LinstorClient::VolumeDefinitionLayer.new }

  describe 'test an instance of VolumeDefinitionLayer' do
    it 'should create an instance of VolumeDefinitionLayer' do
      expect(instance).to be_instance_of(LinstorClient::VolumeDefinitionLayer)
    end
  end
