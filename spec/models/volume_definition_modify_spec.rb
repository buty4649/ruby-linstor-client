...
# Unit tests for LinstorClient::VolumeDefinitionModify
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::VolumeDefinitionModify do
  let(:instance) { LinstorClient::VolumeDefinitionModify.new }

  describe 'test an instance of VolumeDefinitionModify' do
    it 'should create an instance of VolumeDefinitionModify' do
      expect(instance).to be_instance_of(LinstorClient::VolumeDefinitionModify)
    end
  end
