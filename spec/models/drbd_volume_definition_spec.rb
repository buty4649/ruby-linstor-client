...
# Unit tests for LinstorClient::DrbdVolumeDefinition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::DrbdVolumeDefinition do
  let(:instance) { LinstorClient::DrbdVolumeDefinition.new }

  describe 'test an instance of DrbdVolumeDefinition' do
    it 'should create an instance of DrbdVolumeDefinition' do
      expect(instance).to be_instance_of(LinstorClient::DrbdVolumeDefinition)
    end
  end
