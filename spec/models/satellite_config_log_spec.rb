...
# Unit tests for LinstorClient::SatelliteConfigLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::SatelliteConfigLog do
  let(:instance) { LinstorClient::SatelliteConfigLog.new }

  describe 'test an instance of SatelliteConfigLog' do
    it 'should create an instance of SatelliteConfigLog' do
      expect(instance).to be_instance_of(LinstorClient::SatelliteConfigLog)
    end
  end
