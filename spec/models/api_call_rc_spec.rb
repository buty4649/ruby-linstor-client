...
# Unit tests for LinstorClient::ApiCallRc
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ApiCallRc do
  let(:instance) { LinstorClient::ApiCallRc.new }

  describe 'test an instance of ApiCallRc' do
    it 'should create an instance of ApiCallRc' do
      expect(instance).to be_instance_of(LinstorClient::ApiCallRc)
    end
  end
  ...
  describe 'test attribute "correction"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "error_report_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "obj_refs"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
