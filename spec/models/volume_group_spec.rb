...
# Unit tests for LinstorClient::VolumeGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::VolumeGroup do
  let(:instance) { LinstorClient::VolumeGroup.new }

  describe 'test an instance of VolumeGroup' do
    it 'should create an instance of VolumeGroup' do
      expect(instance).to be_instance_of(LinstorClient::VolumeGroup)
    end
  end
