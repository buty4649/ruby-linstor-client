...
# Unit tests for LinstorClient::VolumeModify
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::VolumeModify do
  let(:instance) { LinstorClient::VolumeModify.new }

  describe 'test an instance of VolumeModify' do
    it 'should create an instance of VolumeModify' do
      expect(instance).to be_instance_of(LinstorClient::VolumeModify)
    end
  end
