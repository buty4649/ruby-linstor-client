...
# Unit tests for LinstorClient::OpenflexResource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::OpenflexResource do
  let(:instance) { LinstorClient::OpenflexResource.new }

  describe 'test an instance of OpenflexResource' do
    it 'should create an instance of OpenflexResource' do
      expect(instance).to be_instance_of(LinstorClient::OpenflexResource)
    end
  end
  describe 'test attribute "openflex_resource_definition"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "openflex_volumes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
