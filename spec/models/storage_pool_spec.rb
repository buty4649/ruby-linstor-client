...
# Unit tests for LinstorClient::StoragePool
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::StoragePool do
  let(:instance) { LinstorClient::StoragePool.new }

  describe 'test an instance of StoragePool' do
    it 'should create an instance of StoragePool' do
      expect(instance).to be_instance_of(LinstorClient::StoragePool)
    end
  end
  describe 'test attribute "storage_pool_name"' do
    it 'should work' do
  ...
  describe 'test attribute "static_traits"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "free_space_mgr_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "supports_snapshots"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
