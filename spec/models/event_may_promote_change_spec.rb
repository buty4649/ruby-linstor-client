...
# Unit tests for LinstorClient::EventMayPromoteChange
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::EventMayPromoteChange do
  let(:instance) { LinstorClient::EventMayPromoteChange.new }

  describe 'test an instance of EventMayPromoteChange' do
    it 'should create an instance of EventMayPromoteChange' do
      expect(instance).to be_instance_of(LinstorClient::EventMayPromoteChange)
    end
  end
  ...
  describe 'test attribute "may_promote"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
