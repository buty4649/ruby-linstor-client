...
# Unit tests for LinstorClient::WritecacheResource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::WritecacheResource do
  let(:instance) { LinstorClient::WritecacheResource.new }

  describe 'test an instance of WritecacheResource' do
    it 'should create an instance of WritecacheResource' do
      expect(instance).to be_instance_of(LinstorClient::WritecacheResource)
    end
  end
  describe 'test attribute "writecache_volumes"' do
    it 'should work' do
