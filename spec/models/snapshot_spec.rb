...
# Unit tests for LinstorClient::Snapshot
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::Snapshot do
  let(:instance) { LinstorClient::Snapshot.new }

  describe 'test an instance of Snapshot' do
    it 'should create an instance of Snapshot' do
      expect(instance).to be_instance_of(LinstorClient::Snapshot)
    end
  end
