...
# Unit tests for LinstorClient::DrbdVolume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::DrbdVolume do
  let(:instance) { LinstorClient::DrbdVolume.new }

  describe 'test an instance of DrbdVolume' do
    it 'should create an instance of DrbdVolume' do
      expect(instance).to be_instance_of(LinstorClient::DrbdVolume)
    end
  end
  describe 'test attribute "drbd_volume_definition"' do
    it 'should work' do
  ...
  describe 'test attribute "meta_disk"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "ext_meta_stor_pool"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
