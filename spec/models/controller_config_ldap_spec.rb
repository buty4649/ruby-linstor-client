...
# Unit tests for LinstorClient::ControllerConfigLdap
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ControllerConfigLdap do
  let(:instance) { LinstorClient::ControllerConfigLdap.new }

  describe 'test an instance of ControllerConfigLdap' do
    it 'should create an instance of ControllerConfigLdap' do
      expect(instance).to be_instance_of(LinstorClient::ControllerConfigLdap)
    end
  end
  ...
  describe 'test attribute "public_access_allowed"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
