...
# Unit tests for LinstorClient::ControllerConfigDebug
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ControllerConfigDebug do
  let(:instance) { LinstorClient::ControllerConfigDebug.new }

  describe 'test an instance of ControllerConfigDebug' do
    it 'should create an instance of ControllerConfigDebug' do
      expect(instance).to be_instance_of(LinstorClient::ControllerConfigDebug)
    end
  end
  describe 'test attribute "console_enabled"' do
    it 'should work' do
