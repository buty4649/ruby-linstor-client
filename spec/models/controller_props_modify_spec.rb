...
# Unit tests for LinstorClient::ControllerPropsModify
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ControllerPropsModify do
  let(:instance) { LinstorClient::ControllerPropsModify.new }

  describe 'test an instance of ControllerPropsModify' do
    it 'should create an instance of ControllerPropsModify' do
      expect(instance).to be_instance_of(LinstorClient::ControllerPropsModify)
    end
  end
