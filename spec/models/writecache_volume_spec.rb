...
# Unit tests for LinstorClient::WritecacheVolume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::WritecacheVolume do
  let(:instance) { LinstorClient::WritecacheVolume.new }

  describe 'test an instance of WritecacheVolume' do
    it 'should create an instance of WritecacheVolume' do
      expect(instance).to be_instance_of(LinstorClient::WritecacheVolume)
    end
  end
