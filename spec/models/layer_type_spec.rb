...
# Unit tests for LinstorClient::LayerType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::LayerType do
  let(:instance) { LinstorClient::LayerType.new }

  describe 'test an instance of LayerType' do
    it 'should create an instance of LayerType' do
      expect(instance).to be_instance_of(LinstorClient::LayerType)
    end
  end
end
