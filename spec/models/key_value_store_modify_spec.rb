...
# Unit tests for LinstorClient::KeyValueStoreModify
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::KeyValueStoreModify do
  let(:instance) { LinstorClient::KeyValueStoreModify.new }

  describe 'test an instance of KeyValueStoreModify' do
    it 'should create an instance of KeyValueStoreModify' do
      expect(instance).to be_instance_of(LinstorClient::KeyValueStoreModify)
    end
  end
