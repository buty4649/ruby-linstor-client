...
# Unit tests for LinstorClient::Volume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::Volume do
  let(:instance) { LinstorClient::Volume.new }

  describe 'test an instance of Volume' do
    it 'should create an instance of Volume' do
      expect(instance).to be_instance_of(LinstorClient::Volume)
    end
  end
  ...
  describe 'test attribute "layer_data_list"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
