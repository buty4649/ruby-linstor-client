...
# Unit tests for LinstorClient::DrbdResource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::DrbdResource do
  let(:instance) { LinstorClient::DrbdResource.new }

  describe 'test an instance of DrbdResource' do
    it 'should create an instance of DrbdResource' do
      expect(instance).to be_instance_of(LinstorClient::DrbdResource)
    end
  end
  describe 'test attribute "drbd_resource_definition"' do
    it 'should work' do
  ...
  describe 'test attribute "al_size"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "drbd_volumes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
