...
# Unit tests for LinstorClient::AutoPlaceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::AutoPlaceRequest do
  let(:instance) { LinstorClient::AutoPlaceRequest.new }

  describe 'test an instance of AutoPlaceRequest' do
    it 'should create an instance of AutoPlaceRequest' do
      expect(instance).to be_instance_of(LinstorClient::AutoPlaceRequest)
    end
  end
