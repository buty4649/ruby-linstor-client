...
# Unit tests for LinstorClient::DrbdResourceDefinitionLayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::DrbdResourceDefinitionLayer do
  let(:instance) { LinstorClient::DrbdResourceDefinitionLayer.new }

  describe 'test an instance of DrbdResourceDefinitionLayer' do
    it 'should create an instance of DrbdResourceDefinitionLayer' do
      expect(instance).to be_instance_of(LinstorClient::DrbdResourceDefinitionLayer)
    end
  end
  ...
  describe 'test attribute "peer_slots"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "al_stripes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "al_stripe_size_kib"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
