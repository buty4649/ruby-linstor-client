...
# Unit tests for LinstorClient::StorageResource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::StorageResource do
  let(:instance) { LinstorClient::StorageResource.new }

  describe 'test an instance of StorageResource' do
    it 'should create an instance of StorageResource' do
      expect(instance).to be_instance_of(LinstorClient::StorageResource)
    end
  end
  describe 'test attribute "storage_volumes"' do
    it 'should work' do
