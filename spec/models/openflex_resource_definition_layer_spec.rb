...
# Unit tests for LinstorClient::OpenflexResourceDefinitionLayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::OpenflexResourceDefinitionLayer do
  let(:instance) { LinstorClient::OpenflexResourceDefinitionLayer.new }

  describe 'test an instance of OpenflexResourceDefinitionLayer' do
    it 'should create an instance of OpenflexResourceDefinitionLayer' do
      expect(instance).to be_instance_of(LinstorClient::OpenflexResourceDefinitionLayer)
    end
  end
  ...
  describe 'test attribute "nqn"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
