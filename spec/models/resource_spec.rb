...
# Unit tests for LinstorClient::Resource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::Resource do
  let(:instance) { LinstorClient::Resource.new }

  describe 'test an instance of Resource' do
    it 'should create an instance of Resource' do
      expect(instance).to be_instance_of(LinstorClient::Resource)
    end
  end
