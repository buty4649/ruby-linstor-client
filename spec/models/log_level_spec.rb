...
# Unit tests for LinstorClient::LogLevel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::LogLevel do
  let(:instance) { LinstorClient::LogLevel.new }

  describe 'test an instance of LogLevel' do
    it 'should create an instance of LogLevel' do
      expect(instance).to be_instance_of(LinstorClient::LogLevel)
    end
  end
end
