...
# Unit tests for LinstorClient::DrbdProxyModify
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::DrbdProxyModify do
  let(:instance) { LinstorClient::DrbdProxyModify.new }

  describe 'test an instance of DrbdProxyModify' do
    it 'should create an instance of DrbdProxyModify' do
      expect(instance).to be_instance_of(LinstorClient::DrbdProxyModify)
    end
  end
  ...
  describe 'test attribute "compression_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "zlib", "lzma", "lz4"])
      # validator.allowable_values.each do |value|
      #   expect { instance.compression_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "compression_props"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
