...
# Unit tests for LinstorClient::VolumeDefinition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::VolumeDefinition do
  let(:instance) { LinstorClient::VolumeDefinition.new }

  describe 'test an instance of VolumeDefinition' do
    it 'should create an instance of VolumeDefinition' do
      expect(instance).to be_instance_of(LinstorClient::VolumeDefinition)
    end
  end
