...
# Unit tests for LinstorClient::ErrorReport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ErrorReport do
  let(:instance) { LinstorClient::ErrorReport.new }

  describe 'test an instance of ErrorReport' do
    it 'should create an instance of ErrorReport' do
      expect(instance).to be_instance_of(LinstorClient::ErrorReport)
    end
  end
