...
# Unit tests for LinstorClient::ResourceGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ResourceGroup do
  let(:instance) { LinstorClient::ResourceGroup.new }

  describe 'test an instance of ResourceGroup' do
    it 'should create an instance of ResourceGroup' do
      expect(instance).to be_instance_of(LinstorClient::ResourceGroup)
    end
  end
