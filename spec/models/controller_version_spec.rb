...
# Unit tests for LinstorClient::ControllerVersion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ControllerVersion do
  let(:instance) { LinstorClient::ControllerVersion.new }

  describe 'test an instance of ControllerVersion' do
    it 'should create an instance of ControllerVersion' do
      expect(instance).to be_instance_of(LinstorClient::ControllerVersion)
    end
  end
  ...
  describe 'test attribute "git_hash"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "rest_api_version"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
