...
# Unit tests for LinstorClient::ControllerConfigLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ControllerConfigLog do
  let(:instance) { LinstorClient::ControllerConfigLog.new }

  describe 'test an instance of ControllerConfigLog' do
    it 'should create an instance of ControllerConfigLog' do
      expect(instance).to be_instance_of(LinstorClient::ControllerConfigLog)
    end
  end
  describe 'test attribute "print_stack_trace"' do
    it 'should work' do
  ...
  describe 'test attribute "level_global"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "level_linstor"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "level_linstor_global"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "rest_access_log_path"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "rest_access_mode"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["APPEND", "ROTATE_HOURLY", "ROTATE_DAILY", "NO_LOG"])
      # validator.allowable_values.each do |value|
      #   expect { instance.rest_access_mode = value }.not_to raise_error
      # end
    end
  end
