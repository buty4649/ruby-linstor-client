...
# Unit tests for LinstorClient::KeyValueStore
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::KeyValueStore do
  let(:instance) { LinstorClient::KeyValueStore.new }

  describe 'test an instance of KeyValueStore' do
    it 'should create an instance of KeyValueStore' do
      expect(instance).to be_instance_of(LinstorClient::KeyValueStore)
    end
  end
