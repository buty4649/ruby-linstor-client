...
# Unit tests for LinstorClient::LUKSVolume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::LUKSVolume do
  let(:instance) { LinstorClient::LUKSVolume.new }

  describe 'test an instance of LUKSVolume' do
    it 'should create an instance of LUKSVolume' do
      expect(instance).to be_instance_of(LinstorClient::LUKSVolume)
    end
  end
