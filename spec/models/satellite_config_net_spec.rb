...
# Unit tests for LinstorClient::SatelliteConfigNet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::SatelliteConfigNet do
  let(:instance) { LinstorClient::SatelliteConfigNet.new }

  describe 'test an instance of SatelliteConfigNet' do
    it 'should create an instance of SatelliteConfigNet' do
      expect(instance).to be_instance_of(LinstorClient::SatelliteConfigNet)
    end
  end
  describe 'test attribute "bind_address"' do
    it 'should work' do
  ...
  describe 'test attribute "com_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
