...
# Unit tests for LinstorClient::OpenflexVolume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::OpenflexVolume do
  let(:instance) { LinstorClient::OpenflexVolume.new }

  describe 'test an instance of OpenflexVolume' do
    it 'should create an instance of OpenflexVolume' do
      expect(instance).to be_instance_of(LinstorClient::OpenflexVolume)
    end
  end
