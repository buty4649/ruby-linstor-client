...
# Unit tests for LinstorClient::CacheResource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::CacheResource do
  let(:instance) { LinstorClient::CacheResource.new }

  describe 'test an instance of CacheResource' do
    it 'should create an instance of CacheResource' do
      expect(instance).to be_instance_of(LinstorClient::CacheResource)
    end
  end
  describe 'test attribute "cache_volumes"' do
    it 'should work' do
