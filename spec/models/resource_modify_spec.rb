...
# Unit tests for LinstorClient::ResourceModify
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ResourceModify do
  let(:instance) { LinstorClient::ResourceModify.new }

  describe 'test an instance of ResourceModify' do
    it 'should create an instance of ResourceModify' do
      expect(instance).to be_instance_of(LinstorClient::ResourceModify)
    end
  end
