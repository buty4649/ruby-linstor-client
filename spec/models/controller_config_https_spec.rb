...
# Unit tests for LinstorClient::ControllerConfigHttps
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ControllerConfigHttps do
  let(:instance) { LinstorClient::ControllerConfigHttps.new }

  describe 'test an instance of ControllerConfigHttps' do
    it 'should create an instance of ControllerConfigHttps' do
      expect(instance).to be_instance_of(LinstorClient::ControllerConfigHttps)
    end
  end
  ...
  describe 'test attribute "listen_address"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
