...
# Unit tests for LinstorClient::VolumeState
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::VolumeState do
  let(:instance) { LinstorClient::VolumeState.new }

  describe 'test an instance of VolumeState' do
    it 'should create an instance of VolumeState' do
      expect(instance).to be_instance_of(LinstorClient::VolumeState)
    end
  end
