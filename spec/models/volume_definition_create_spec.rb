...
# Unit tests for LinstorClient::VolumeDefinitionCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::VolumeDefinitionCreate do
  let(:instance) { LinstorClient::VolumeDefinitionCreate.new }

  describe 'test an instance of VolumeDefinitionCreate' do
    it 'should create an instance of VolumeDefinitionCreate' do
      expect(instance).to be_instance_of(LinstorClient::VolumeDefinitionCreate)
    end
  end
  describe 'test attribute "volume_definition"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "drbd_minor_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
