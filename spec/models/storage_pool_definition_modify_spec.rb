...
# Unit tests for LinstorClient::StoragePoolDefinitionModify
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::StoragePoolDefinitionModify do
  let(:instance) { LinstorClient::StoragePoolDefinitionModify.new }

  describe 'test an instance of StoragePoolDefinitionModify' do
    it 'should create an instance of StoragePoolDefinitionModify' do
      expect(instance).to be_instance_of(LinstorClient::StoragePoolDefinitionModify)
    end
  end
