...
# Unit tests for LinstorClient::ControllerConfigConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ControllerConfigConfig do
  let(:instance) { LinstorClient::ControllerConfigConfig.new }

  describe 'test an instance of ControllerConfigConfig' do
    it 'should create an instance of ControllerConfigConfig' do
      expect(instance).to be_instance_of(LinstorClient::ControllerConfigConfig)
    end
  end
