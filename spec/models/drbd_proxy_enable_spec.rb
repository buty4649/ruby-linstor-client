...
# Unit tests for LinstorClient::DrbdProxyEnable
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::DrbdProxyEnable do
  let(:instance) { LinstorClient::DrbdProxyEnable.new }

  describe 'test an instance of DrbdProxyEnable' do
    it 'should create an instance of DrbdProxyEnable' do
      expect(instance).to be_instance_of(LinstorClient::DrbdProxyEnable)
    end
  end
