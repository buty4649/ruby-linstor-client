...
# Unit tests for LinstorClient::CacheVolume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::CacheVolume do
  let(:instance) { LinstorClient::CacheVolume.new }

  describe 'test an instance of CacheVolume' do
    it 'should create an instance of CacheVolume' do
      expect(instance).to be_instance_of(LinstorClient::CacheVolume)
    end
  end
  ...
  describe 'test attribute "device_path_cache"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "device_meta_cache"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
