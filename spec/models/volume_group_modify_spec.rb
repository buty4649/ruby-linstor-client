...
# Unit tests for LinstorClient::VolumeGroupModify
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::VolumeGroupModify do
  let(:instance) { LinstorClient::VolumeGroupModify.new }

  describe 'test an instance of VolumeGroupModify' do
    it 'should create an instance of VolumeGroupModify' do
      expect(instance).to be_instance_of(LinstorClient::VolumeGroupModify)
    end
  end
