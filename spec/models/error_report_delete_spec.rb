...
# Unit tests for LinstorClient::ErrorReportDelete
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ErrorReportDelete do
  let(:instance) { LinstorClient::ErrorReportDelete.new }

  describe 'test an instance of ErrorReportDelete' do
    it 'should create an instance of ErrorReportDelete' do
      expect(instance).to be_instance_of(LinstorClient::ErrorReportDelete)
    end
  end
