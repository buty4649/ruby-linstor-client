...
# Unit tests for LinstorClient::VolumeLayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::VolumeLayer do
  let(:instance) { LinstorClient::VolumeLayer.new }

  describe 'test an instance of VolumeLayer' do
    it 'should create an instance of VolumeLayer' do
      expect(instance).to be_instance_of(LinstorClient::VolumeLayer)
    end
  end
