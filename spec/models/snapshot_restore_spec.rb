...
# Unit tests for LinstorClient::SnapshotRestore
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::SnapshotRestore do
  let(:instance) { LinstorClient::SnapshotRestore.new }

  describe 'test an instance of SnapshotRestore' do
    it 'should create an instance of SnapshotRestore' do
      expect(instance).to be_instance_of(LinstorClient::SnapshotRestore)
    end
  end
  describe 'test attribute "to_resource"' do
    it 'should work' do
