...
# Unit tests for LinstorClient::ResourceLayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ResourceLayer do
  let(:instance) { LinstorClient::ResourceLayer.new }

  describe 'test an instance of ResourceLayer' do
    it 'should create an instance of ResourceLayer' do
      expect(instance).to be_instance_of(LinstorClient::ResourceLayer)
    end
  end
  ...
  describe 'test attribute "drbd"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "luks"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "nvme"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "writecache"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
