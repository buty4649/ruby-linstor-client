...
# Unit tests for LinstorClient::StorageVolume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::StorageVolume do
  let(:instance) { LinstorClient::StorageVolume.new }

  describe 'test an instance of StorageVolume' do
    it 'should create an instance of StorageVolume' do
      expect(instance).to be_instance_of(LinstorClient::StorageVolume)
    end
  end
