...
# Unit tests for LinstorClient::StoragePoolDefinition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::StoragePoolDefinition do
  let(:instance) { LinstorClient::StoragePoolDefinition.new }

  describe 'test an instance of StoragePoolDefinition' do
    it 'should create an instance of StoragePoolDefinition' do
      expect(instance).to be_instance_of(LinstorClient::StoragePoolDefinition)
    end
  end
