...
# Unit tests for LinstorClient::ControllerConfigHttp
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ControllerConfigHttp do
  let(:instance) { LinstorClient::ControllerConfigHttp.new }

  describe 'test an instance of ControllerConfigHttp' do
    it 'should create an instance of ControllerConfigHttp' do
      expect(instance).to be_instance_of(LinstorClient::ControllerConfigHttp)
    end
  end
