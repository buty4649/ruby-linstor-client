...
# Unit tests for LinstorClient::ResourceWithVolumes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ResourceWithVolumes do
  let(:instance) { LinstorClient::ResourceWithVolumes.new }

  describe 'test an instance of ResourceWithVolumes' do
    it 'should create an instance of ResourceWithVolumes' do
      expect(instance).to be_instance_of(LinstorClient::ResourceWithVolumes)
    end
  end
  ...
  describe 'test attribute "layer_object"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
