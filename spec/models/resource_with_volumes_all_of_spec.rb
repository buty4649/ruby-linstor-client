...
# Unit tests for LinstorClient::ResourceWithVolumesAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ResourceWithVolumesAllOf do
  let(:instance) { LinstorClient::ResourceWithVolumesAllOf.new }

  describe 'test an instance of ResourceWithVolumesAllOf' do
    it 'should create an instance of ResourceWithVolumesAllOf' do
      expect(instance).to be_instance_of(LinstorClient::ResourceWithVolumesAllOf)
    end
  end
