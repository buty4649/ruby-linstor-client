...
# Unit tests for LinstorClient::ControllerConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinstorClient::ControllerConfig do
  let(:instance) { LinstorClient::ControllerConfig.new }

  describe 'test an instance of ControllerConfig' do
    it 'should create an instance of ControllerConfig' do
      expect(instance).to be_instance_of(LinstorClient::ControllerConfig)
    end
  end
