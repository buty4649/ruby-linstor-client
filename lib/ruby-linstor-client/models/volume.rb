  ...
  class Volume
    ...
    def self.openapi_types
      {
        ...
        :'flags' => :'Array<String>',
        :'state' => :'VolumeState',
        :'layer_data_list' => :'Array<VolumeLayer>',
        :'uuid' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::Volume` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::Volume`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'layer_data_list')
        if (value = attributes[:'layer_data_list']).is_a?(Array)
          self.layer_data_list = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flags == o.flags &&
          state == o.state &&
          layer_data_list == o.layer_data_list &&
          uuid == o.uuid &&
          reports == o.reports
    end
    ...
    def hash
      [volume_number, storage_pool_name, provider_kind, device_path, allocated_size_kib, usable_size_kib, props, flags, state, layer_data_list, uuid, reports].hash
    end
