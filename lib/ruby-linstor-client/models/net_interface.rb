...
module LinstorClient
  class NetInterface
    ...
    attr_accessor :satellite_port

    attr_accessor :satellite_encryption_type
    ...
    def self.openapi_types
      {
        :'name' => :'String',
        :'address' => :'String',
        :'satellite_port' => :'Integer',
        :'satellite_encryption_type' => :'String',
        :'is_active' => :'Boolean',
        :'uuid' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::NetInterface` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::NetInterface`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'satellite_port')
        self.satellite_port = attributes[:'satellite_port']
      end

      if attributes.key?(:'satellite_encryption_type')
        self.satellite_encryption_type = attributes[:'satellite_encryption_type']
      end
    ...
    def valid?
      ...
      satellite_encryption_type_validator = EnumAttributeValidator.new('String', ["PLAIN", "SSL"])
      return false unless satellite_encryption_type_validator.valid?(@satellite_encryption_type)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] satellite_encryption_type Object to be assigned
    def satellite_encryption_type=(satellite_encryption_type)
      validator = EnumAttributeValidator.new('String', ["PLAIN", "SSL"])
      unless validator.valid?(satellite_encryption_type)
        fail ArgumentError, "invalid value for \"satellite_encryption_type\", must be one of #{validator.allowable_values}."
      end
      @satellite_encryption_type = satellite_encryption_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          address == o.address &&
          satellite_port == o.satellite_port &&
          satellite_encryption_type == o.satellite_encryption_type &&
    ...
    def hash
      [name, address, satellite_port, satellite_encryption_type, is_active, uuid].hash
    end
