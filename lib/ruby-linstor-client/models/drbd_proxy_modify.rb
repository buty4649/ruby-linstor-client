...
module LinstorClient
  class DrbdProxyModify
    ...
    # A string to string property map.
    attr_accessor :compression_props
    ...
    def self.attribute_map
      {
        ...
        :'compression_props' => :'compression_props'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'compression_props' => :'Hash<String, String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::DrbdProxyModify` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::DrbdProxyModify`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'compression_props')
        if (value = attributes[:'compression_props']).is_a?(Hash)
          self.compression_props = value
        end
      end
    end
    ...
    def valid?
      compression_type_validator = EnumAttributeValidator.new('String', ["none", "zlib", "lzma", "lz4"])
    ...
    def compression_type=(compression_type)
      validator = EnumAttributeValidator.new('String', ["none", "zlib", "lzma", "lz4"])
      unless validator.valid?(compression_type)
        fail ArgumentError, "invalid value for \"compression_type\", must be one of #{validator.allowable_values}."
      end
      @compression_type = compression_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          compression_props == o.compression_props
    end
    ...
    def hash
      [override_props, delete_props, compression_type, compression_props].hash
    end
