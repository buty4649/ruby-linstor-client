...
module LinstorClient
  class SatelliteConfig
    ...
    attr_accessor :stlt_override_node_name

    attr_accessor :openflex

    attr_accessor :drbd_keep_res_pattern
    ...
    def self.attribute_map
      {
        ...
        :'debug' => :'debug',
        :'log' => :'log',
        :'stlt_override_node_name' => :'stlt_override_node_name',
        :'openflex' => :'openflex',
        :'drbd_keep_res_pattern' => :'drbd_keep_res_pattern',
        :'net' => :'net'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::SatelliteConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::SatelliteConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'stlt_override_node_name')
        self.stlt_override_node_name = attributes[:'stlt_override_node_name']
      end

      if attributes.key?(:'openflex')
        self.openflex = attributes[:'openflex']
      end

      if attributes.key?(:'drbd_keep_res_pattern')
        self.drbd_keep_res_pattern = attributes[:'drbd_keep_res_pattern']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          debug == o.debug &&
          log == o.log &&
          stlt_override_node_name == o.stlt_override_node_name &&
          openflex == o.openflex &&
          drbd_keep_res_pattern == o.drbd_keep_res_pattern &&
          net == o.net
    end
    ...
    def hash
      [config, debug, log, stlt_override_node_name, openflex, drbd_keep_res_pattern, net].hash
    end
