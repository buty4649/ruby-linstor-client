...
module LinstorClient
  class ControllerConfigDb
    ...
    attr_accessor :version_check_disabled
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::ControllerConfigDb` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::ControllerConfigDb`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'in_memory')
        self.in_memory = attributes[:'in_memory']
      end

      if attributes.key?(:'version_check_disabled')
        self.version_check_disabled = attributes[:'version_check_disabled']
      end

      if attributes.key?(:'etcd')
        self.etcd = attributes[:'etcd']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          version_check_disabled == o.version_check_disabled &&
          etcd == o.etcd
    end
    ...
    def hash
      [connection_url, ca_certificate, client_certificate, in_memory, version_check_disabled, etcd].hash
    end
