...
module LinstorClient
  class ResourceGroupSpawn
    # name of the resulting resource-definition
    attr_accessor :resource_definition_name
    ...
    attr_accessor :resource_definition_external_name

    # sizes (in kib) of the resulting volume-definitions
    attr_accessor :volume_sizes

    attr_accessor :select_filter
    ...
    attr_accessor :definitions_only

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'resource_definition_name' => :'resource_definition_name',
        :'resource_definition_external_name' => :'resource_definition_external_name',
    ...
    def self.openapi_types
      {
        ...
        :'resource_definition_external_name' => :'String',
        :'volume_sizes' => :'Array<Integer>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::ResourceGroupSpawn` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::ResourceGroupSpawn`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'resource_definition_name')
        self.resource_definition_name = attributes[:'resource_definition_name']
      end

      if attributes.key?(:'resource_definition_external_name')
        self.resource_definition_external_name = attributes[:'resource_definition_external_name']
      end

      if attributes.key?(:'volume_sizes')
        if (value = attributes[:'volume_sizes']).is_a?(Array)
          self.volume_sizes = value
        end
      end

      if attributes.key?(:'select_filter')
        self.select_filter = attributes[:'select_filter']
      end
      ...
      if attributes.key?(:'definitions_only')
        self.definitions_only = attributes[:'definitions_only']
      else
    ...
    def ==(o)
      ...
      self.class == o.class &&
          resource_definition_name == o.resource_definition_name &&
          resource_definition_external_name == o.resource_definition_external_name &&
          volume_sizes == o.volume_sizes &&
          select_filter == o.select_filter &&
          partial == o.partial &&
          definitions_only == o.definitions_only
    end
    ...
    def hash
      [resource_definition_name, resource_definition_external_name, volume_sizes, select_filter, partial, definitions_only].hash
    end
