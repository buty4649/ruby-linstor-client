...
module LinstorClient
  class ControllerConfigDbEtcd
    attr_accessor :operations_per_transaction
    ...
    def self.openapi_types
      {
        :'operations_per_transaction' => :'Integer',
        :'prefix' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::ControllerConfigDbEtcd` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::ControllerConfigDbEtcd`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'operations_per_transaction')
        self.operations_per_transaction = attributes[:'operations_per_transaction']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          operations_per_transaction == o.operations_per_transaction &&
          prefix == o.prefix
    end
    ...
    def hash
      [operations_per_transaction, prefix].hash
    end
