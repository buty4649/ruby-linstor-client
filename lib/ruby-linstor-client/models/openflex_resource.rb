...
module LinstorClient
  class OpenflexResource
    attr_accessor :openflex_resource_definition

    attr_accessor :openflex_volumes

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'openflex_resource_definition' => :'openflex_resource_definition',
        :'openflex_volumes' => :'openflex_volumes'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'openflex_volumes' => :'Array<OpenflexVolume>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::OpenflexResource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::OpenflexResource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'openflex_resource_definition')
        self.openflex_resource_definition = attributes[:'openflex_resource_definition']
      end

      if attributes.key?(:'openflex_volumes')
        if (value = attributes[:'openflex_volumes']).is_a?(Array)
          self.openflex_volumes = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          openflex_resource_definition == o.openflex_resource_definition &&
          openflex_volumes == o.openflex_volumes
    end
    ...
    def hash
      [openflex_resource_definition, openflex_volumes].hash
    end
