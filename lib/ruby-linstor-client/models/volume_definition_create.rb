...
module LinstorClient
  class VolumeDefinitionCreate
    attr_accessor :volume_definition

    attr_accessor :drbd_minor_number

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'volume_definition' => :'volume_definition',
        :'drbd_minor_number' => :'drbd_minor_number'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::VolumeDefinitionCreate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::VolumeDefinitionCreate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'volume_definition')
        self.volume_definition = attributes[:'volume_definition']
      end

      if attributes.key?(:'drbd_minor_number')
        self.drbd_minor_number = attributes[:'drbd_minor_number']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @volume_definition.nil?
        invalid_properties.push('invalid value for "volume_definition", volume_definition cannot be nil.')
      end
    ...
    def valid?
      return false if @volume_definition.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          volume_definition == o.volume_definition &&
          drbd_minor_number == o.drbd_minor_number
    end
    ...
    def hash
      [volume_definition, drbd_minor_number].hash
    end
