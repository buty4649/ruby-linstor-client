  ...
  class VolumeDefinition
    ...
    def self.openapi_types
      {
        ...
        :'flags' => :'Array<String>',
        :'layer_data' => :'Array<VolumeDefinitionLayer>',
        :'uuid' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::VolumeDefinition` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::VolumeDefinition`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'size_kib')
        self.size_kib = attributes[:'size_kib']
      end
    ...
    def list_invalid_properties
      ...
      if @size_kib.nil?
        invalid_properties.push('invalid value for "size_kib", size_kib cannot be nil.')
      end
    ...
    def hash
      [volume_number, size_kib, props, flags, layer_data, uuid].hash
    end
