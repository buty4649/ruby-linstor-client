...
module LinstorClient
  class ResourceDefinition
    ...
    attr_accessor :volume_definitions
    ...
    def self.openapi_types
      {
        ...
        :'flags' => :'Array<String>',
        :'layer_data' => :'Array<ResourceDefinitionLayer>',
        :'uuid' => :'String',
        :'resource_group_name' => :'String',
        :'volume_definitions' => :'Array<VolumeDefinition>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::ResourceDefinition` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::ResourceDefinition`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'layer_data')
        if (value = attributes[:'layer_data']).is_a?(Array)
          self.layer_data = value
        end
      end
      ...
      if attributes.key?(:'volume_definitions')
        if (value = attributes[:'volume_definitions']).is_a?(Array)
          self.volume_definitions = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          props == o.props &&
          flags == o.flags &&
          layer_data == o.layer_data &&
          uuid == o.uuid &&
          resource_group_name == o.resource_group_name &&
          volume_definitions == o.volume_definitions
    end
    ...
    def hash
      [name, external_name, props, flags, layer_data, uuid, resource_group_name, volume_definitions].hash
    end
