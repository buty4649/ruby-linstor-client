  ...
  class ApiCallRc
    ...
    def self.attribute_map
      {
        ...
        :'error_report_ids' => :'error_report_ids',
        :'obj_refs' => :'obj_refs'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'details' => :'String',
        :'correction' => :'String',
        :'error_report_ids' => :'Array<String>',
        :'obj_refs' => :'Hash<String, String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::ApiCallRc` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::ApiCallRc`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'ret_code')
      ...
      if attributes.key?(:'correction')
        self.correction = attributes[:'correction']
      end

      if attributes.key?(:'error_report_ids')
        if (value = attributes[:'error_report_ids']).is_a?(Array)
          self.error_report_ids = value
        end
      end

      if attributes.key?(:'obj_refs')
        if (value = attributes[:'obj_refs']).is_a?(Hash)
          self.obj_refs = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ret_code.nil?
        invalid_properties.push('invalid value for "ret_code", ret_code cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error_report_ids == o.error_report_ids &&
          obj_refs == o.obj_refs
    end
    ...
    def hash
      [ret_code, message, cause, details, correction, error_report_ids, obj_refs].hash
    end
