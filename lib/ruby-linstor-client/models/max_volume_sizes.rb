...
module LinstorClient
  class MaxVolumeSizes
    attr_accessor :candidates

    attr_accessor :default_max_oversubscription_ratio

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'candidates' => :'candidates',
        :'default_max_oversubscription_ratio' => :'default_max_oversubscription_ratio'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'default_max_oversubscription_ratio' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::MaxVolumeSizes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::MaxVolumeSizes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'default_max_oversubscription_ratio')
        self.default_max_oversubscription_ratio = attributes[:'default_max_oversubscription_ratio']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          default_max_oversubscription_ratio == o.default_max_oversubscription_ratio
    end
    ...
    def hash
      [candidates, default_max_oversubscription_ratio].hash
    end
