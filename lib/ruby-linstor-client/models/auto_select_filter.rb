...
module LinstorClient
  class AutoSelectFilter
    attr_accessor :place_count

    attr_accessor :node_name_list

    attr_accessor :storage_pool

    attr_accessor :storage_pool_list

    attr_accessor :not_place_with_rsc

    attr_accessor :not_place_with_rsc_regex

    attr_accessor :replicas_on_same

    attr_accessor :replicas_on_different

    attr_accessor :layer_stack

    attr_accessor :provider_list

    attr_accessor :diskless_on_remaining
    ...
    def self.openapi_types
      {
        ...
        :'storage_pool' => :'String',
        :'storage_pool_list' => :'Array<String>',
        :'not_place_with_rsc' => :'Array<String>',
        :'not_place_with_rsc_regex' => :'String',
        :'replicas_on_same' => :'Array<String>',
        :'replicas_on_different' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::AutoSelectFilter` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::AutoSelectFilter`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'place_count')
        self.place_count = attributes[:'place_count']
      end

      if attributes.key?(:'node_name_list')
        if (value = attributes[:'node_name_list']).is_a?(Array)
          self.node_name_list = value
        end
      end
      ...
      if attributes.key?(:'storage_pool_list')
        if (value = attributes[:'storage_pool_list']).is_a?(Array)
          self.storage_pool_list = value
        end
      end

      if attributes.key?(:'not_place_with_rsc')
        if (value = attributes[:'not_place_with_rsc']).is_a?(Array)
          self.not_place_with_rsc = value
        end
      end

      if attributes.key?(:'not_place_with_rsc_regex')
        self.not_place_with_rsc_regex = attributes[:'not_place_with_rsc_regex']
      end

      if attributes.key?(:'replicas_on_same')
        if (value = attributes[:'replicas_on_same']).is_a?(Array)
          self.replicas_on_same = value
        end
      end

      if attributes.key?(:'replicas_on_different')
        if (value = attributes[:'replicas_on_different']).is_a?(Array)
          self.replicas_on_different = value
        end
      end

      if attributes.key?(:'layer_stack')
        if (value = attributes[:'layer_stack']).is_a?(Array)
          self.layer_stack = value
        end
      end

      if attributes.key?(:'provider_list')
        if (value = attributes[:'provider_list']).is_a?(Array)
          self.provider_list = value
        end
      end

      if attributes.key?(:'diskless_on_remaining')
        self.diskless_on_remaining = attributes[:'diskless_on_remaining']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @place_count.nil?
        invalid_properties.push('invalid value for "place_count", place_count cannot be nil.')
      end
    ...
    def valid?
      return false if @place_count.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          node_name_list == o.node_name_list &&
          storage_pool == o.storage_pool &&
          storage_pool_list == o.storage_pool_list &&
          not_place_with_rsc == o.not_place_with_rsc &&
          not_place_with_rsc_regex == o.not_place_with_rsc_regex &&
          replicas_on_same == o.replicas_on_same &&
          replicas_on_different == o.replicas_on_different &&
          layer_stack == o.layer_stack &&
          provider_list == o.provider_list &&
          diskless_on_remaining == o.diskless_on_remaining
    end
    ...
    def hash
      [place_count, node_name_list, storage_pool, storage_pool_list, not_place_with_rsc, not_place_with_rsc_regex, replicas_on_same, replicas_on_different, layer_stack, provider_list, diskless_on_remaining].hash
    end
