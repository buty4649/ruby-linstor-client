...
module LinstorClient
  class ProviderKind
    DISKLESS = "DISKLESS".freeze
    LVM = "LVM".freeze
    LVM_THIN = "LVM_THIN".freeze
    ZFS = "ZFS".freeze
    ZFS_THIN = "ZFS_THIN".freeze
    OPENFLEX_TARGET = "OPENFLEX_TARGET".freeze
    FILE = "FILE".freeze
    FILE_THIN = "FILE_THIN".freeze
    SPDK = "SPDK".freeze
    ...
    def build_from_hash(value)
      constantValues = ProviderKind.constants.select { |c| ProviderKind::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #ProviderKind" if constantValues.empty?
      value
    end
  end
end
