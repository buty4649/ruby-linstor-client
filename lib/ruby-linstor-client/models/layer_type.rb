...
module LinstorClient
  class LayerType
    ...
    NVME = "NVME".freeze
    WRITECACHE = "WRITECACHE".freeze
    CACHE = "CACHE".freeze
    OPENFLEX = "OPENFLEX".freeze
    ...
    def build_from_hash(value)
      constantValues = LayerType.constants.select { |c| LayerType::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #LayerType" if constantValues.empty?
      value
    end
  end
end
