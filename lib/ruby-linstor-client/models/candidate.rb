...
module LinstorClient
  class Candidate
    ...
    # maximum size in KiB
    attr_accessor :max_volume_size_kib

    attr_accessor :node_names

    attr_accessor :all_thin

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'storage_pool' => :'storage_pool',
        :'max_volume_size_kib' => :'max_volume_size_kib',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::Candidate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::Candidate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'max_volume_size_kib')
        self.max_volume_size_kib = attributes[:'max_volume_size_kib']
      end

      if attributes.key?(:'node_names')
        if (value = attributes[:'node_names']).is_a?(Array)
          self.node_names = value
        end
      end

      if attributes.key?(:'all_thin')
        self.all_thin = attributes[:'all_thin']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_volume_size_kib == o.max_volume_size_kib &&
          node_names == o.node_names &&
          all_thin == o.all_thin
    end
    ...
    def hash
      [storage_pool, max_volume_size_kib, node_names, all_thin].hash
    end
