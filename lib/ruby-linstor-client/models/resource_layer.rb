  ...
  class ResourceLayer
    ...
    def self.openapi_types
      {
        ...
        :'nvme' => :'NVMEResource',
        :'openflex' => :'OpenflexResource',
        :'writecache' => :'WritecacheResource',
        :'cache' => :'CacheResource'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinstorClient::ResourceLayer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinstorClient::ResourceLayer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'drbd')
        self.drbd = attributes[:'drbd']
      end

      if attributes.key?(:'luks')
        self.luks = attributes[:'luks']
      end
      ...
      if attributes.key?(:'writecache')
        self.writecache = attributes[:'writecache']
      end
    ...
    def hash
      [children, resource_name_suffix, type, drbd, luks, storage, nvme, openflex, writecache, cache].hash
    end
